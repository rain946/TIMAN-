...
export default function QRScannerScreen() {
  ...
  const extractQrCode = (
    ...
    // Remove accidental whitespace from the QR URL.
    const value = scannedValue
      .trim()
      .replace(/\s+/g, "");

    /*
      Supported TIMAN QR formats:

      https://domain.com/public/pet/QR_TOKEN

      or raw token:

      442a25d5-9648-4411-b8db-8f66c458eb94
    */
    ...
    // Fallback:
    // If it looks like a TIMAN public pet URL
    // but URL parsing failed, get everything
    // after /public/pet/.
